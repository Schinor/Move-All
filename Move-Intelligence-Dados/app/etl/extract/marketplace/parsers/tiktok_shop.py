"""Parser de acompanhamento do TikTok Shop — v1 conservador (A2, A7).

SEM fixture real (A7: páginas /pdp/ voltaram vazias no unlocker — fonte
marcada `unavailable` em `social_sources_status`). Só JSON-LD (oferta
única) + título genérico; sem padrão validado, preço ambíguo vira
`partial`.
"""
