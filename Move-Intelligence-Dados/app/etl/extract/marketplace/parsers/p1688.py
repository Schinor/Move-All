"""Parser de acompanhamento do 1688 — v1 conservador (A2).

SEM fixture real (A1: oferta detail.1688.com voltou vazia no unlocker).
Só JSON-LD (oferta única) + título genérico; sem padrão validado, preço
ambíguo vira `partial`. Campos B2B (fornecedor, MOQ, faixas) entram quando
houver fixture.
"""
